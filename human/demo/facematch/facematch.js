...
async function main() {
  ...
  // const res = await fetch('/home/nayan/Documents/AI/human/samples/in');
  // console.log((res && res.ok) ? "True":"False")
  ...
  images=`captured/captured.jpg`;
  const t0 = human.now();
  await addImageElement(0, images, 1);
  ...
  console.log((!db || db.length==0)?"No DB":"DB present")
